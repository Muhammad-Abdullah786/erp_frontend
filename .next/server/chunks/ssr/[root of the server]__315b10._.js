    ...
    const client_verify = async (amount)=>{
        try {
            ...
            if (client_id.status === 200) {
                ...
                // })
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`Payment Processing on ${new Date().toLocaleDateString()}`);
                router.push("/payment");
            }
        } catch (error) {
            console.log(error);
